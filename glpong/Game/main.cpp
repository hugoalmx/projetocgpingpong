...
// parâmetros gráficos
const float paddleSpeed = 175.0f; // velocidade das raquetes
const float paddleHeight = 100.0f; // altura das raquetes 
const float halfPaddleHeight = paddleHeight / 2.0f; // metade da altura das raquetes
const float paddleWidth = 10.0f; // largura das raquetes
const float halfPaddleWidth = paddleWidth / 2.0f; // metade da largura das raquetes
